...
export const EventItem01 = (props: TImageProps) => {
  ...
  return (
    <motion.div ref={componentRef} style={style} className="event-item-1">
      <div className="glass-gradient-service w-full h-full p-2 md:p-5">
        ...
        <h4 className="mt-3 md:text-md xl:text-2xl  font-[500]">
          Event Item - 1
        </h4>
      </div>
    </motion.div>
...
export const EventItem02 = (props: TImageProps) => {
  const { style, componentRef } = useScrollGrow();
  return (
...
export const EventItem03 = (props: TImageProps) => {
  const { style, componentRef } = useScrollGrow();
  return (
...
export const EventItem04 = (props: TImageProps) => {
  const { style, componentRef } = useScrollGrow();
  return (
...
export const EventItem05 = (props: TImageProps) => {
  const { style, componentRef } = useScrollGrow();
  return (
...
export const EventItem06 = (props: TImageProps) => {
  const { style, componentRef } = useScrollGrow();
  return (
